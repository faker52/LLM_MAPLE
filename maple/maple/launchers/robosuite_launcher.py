...
from maple.samplers.data_collector.path_collector import EvoPathCollector
from maple.core.population import Population
...
def experiment(variant):
    ...
    LLM_actions = variant.get('LLM_actions', {})
    LLM_weight = variant.get('LLM_weight', {})
    ...
    pop = Population(variant=variant)
    evo_path_collector = EvoPathCollector(
        expl_env,
        policy,
        population=pop,
        save_env_in_snapshot=False,
    ...
    algorithm = TorchBatchRLAlgorithm(
        ...
        evolution_data_collector=evo_path_collector,
